...
import Final_Version.lastFM.geoMethods;
import Final_Version.parser.FileMapForTesting;
import Final_Version.suTime.SUTime_Titoli;
import Final_Version.training.CleanTitle;
import Final_Version.boilerpipe.Boilerpipe;
...
import Final_Version.events.MsnSearchEngine;
...
public class CreateTitleForTesting {
	...
	public static HashMap<String, ArrayList<String[]>> createTitle() {
				...
				for(String urlString: urls) {
					...
					try {
						...
						if(personaTagg && dataTagg && (cittaTagg || sedeTagg)) {
							...
							train++;
							System.out.println("Testing numero "+train);
		...
		FileMapForTesting.fromMapToText(dominio_dati, "FinalDataBROWN/Map2Text.txt");
