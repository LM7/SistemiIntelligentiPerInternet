...
public class CrossValidation {
    ...
    public static void doCrossValidation(String[] dati) throws IOException {
    	System.out.println("==== Cross Validation Brown corpus ====");
    	/**
    	if (args.length != 2) {
        ...
        **/
        ...
        String corpusType = dati[0];
        String corpusFilename = dati[1];
