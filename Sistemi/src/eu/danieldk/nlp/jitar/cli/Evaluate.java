...
public class Evaluate {
    public static void doEvaluation(String[] dati) throws IOException {
    	System.out.println("==== Evaluate Brown model corpus ====");
    	/**
    	if (args.length != 3) {
        ...
        **/
        ...
        try {
            model = Model.readModel(new File(dati[1]));
        } catch (IOException e) {
        ...
        try (CorpusReader corpusReader = Util.newCorpusReader(dati[0], new File(dati[2]))) {
